			...
			<div class="panel panel-default">
				...
				<div class="panel-body">					
					<div class="table-container">
						<form id="create_magissue" method="POST" action="{{ route('magissue.store') }}"  role="form">
							{{ csrf_field() }}
							<div class="row">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										* Número de páginas:
										<input type="number" name="pages_num" id="pages_num" class="form-control" placeholder=""
											   value="{{old('pages_num')??''}}">
									</div>
								</div>
							</div>
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										* Número de ejemplares:
										<input type="number" name="copies_num" id="copies_num" class="form-control" placeholder=""
											   value="{{old('copies_num')??''}}">
									</div>
								</div>
							</div>
